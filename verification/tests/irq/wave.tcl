add_wave_group soc
    add_wave_group -into soc soc_ext_intf
        ...
        add_wave -into soc_ext_intf {{/testbench_top/pito_inf/soc_ext/mvu_irq}}
    ...
    add_wave_group -into soc uart
        ...
        add_wave -into pito {{/testbench_top/soc/io_read}}
        add_wave -into pito {{/testbench_top/soc/io_val}}
...
add_wave_group core
    ...
    add_wave_group -into core EXStage
        ...
        add_wave -into EXStage {{/testbench_top/soc/pito/rv32_ex_rs2_skip}}
        add_wave -into EXStage {{/testbench_top/soc/pito/rv32_ex_dmem_addr}}
    ...
    add_wave_group -into core WBStage
        ...
        add_wave -into WBStage {{/testbench_top/soc/pito/is_store}}
        add_wave -into WBStage {{/testbench_top/soc/pito/is_load}}
        add_wave -into WBStage {{/testbench_top/soc/pito/rv32_wb_is_load}}
    ...
    add_wave_group -into core WFStage
        ...
        add_wave -into WFStage {{/testbench_top/soc/pito/rv32_wb_dmem_addr}}
        ...
        add_wave -into WFStage {{/testbench_top/soc/pito/rv32_regf_wen}}
        add_wave -into WFStage {{/testbench_top/soc/pito/rv32_regf_wa}}
        add_wave -into WFStage {{/testbench_top/soc/pito/rv32_wf_is_load}}
    add_wave_group -into core Next_PC
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/csr_irq_evt}}
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/hart_id_i}}
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/irq_queue_d}}
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/irq_queue_q}}
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/irq_data_ptr_d}}
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/irq_data_ptr_q}}
        ...
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/rv32_next_pc}}
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/rv32_new_pc}}
        add_wave -into Next_PC {{/testbench_top/soc/pito/rv32_next_pc_cal/IrqQueueDepth}}
...
add_wave_group csr
    ...
    add_wave_group -into csr csr1
            add_wave -into csr1 {{/testbench_top/soc/pito/csr/\genblk1[1].csrfile }}
    add_wave_group -into csr csr2
            add_wave -into csr2 {{/testbench_top/soc/pito/csr/\genblk1[2].csrfile }}
    add_wave_group -into csr csr3
            add_wave -into csr3 {{/testbench_top/soc/pito/csr/\genblk1[3].csrfile }}
    add_wave_group -into csr csr4
            add_wave -into csr4 {{/testbench_top/soc/pito/csr/\genblk1[4].csrfile }}
    add_wave_group -into csr csr5
            add_wave -into csr5 {{/testbench_top/soc/pito/csr/\genblk1[5].csrfile }}
    add_wave_group -into csr csr6
            add_wave -into csr6 {{/testbench_top/soc/pito/csr/\genblk1[6].csrfile }}
    add_wave_group -into csr csr7
            add_wave -into csr7 {{/testbench_top/soc/pito/csr/\genblk1[7].csrfile }}
